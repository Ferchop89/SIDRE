...
@section('content')
  ...
  <div class="modal-dialog modal-dialog-custom">
          ...
          <div class="modal-body">
            ...
            <form class="" id="loginForm" name="form-login" action="" method="post" accept-charset="UTF-8">
                        ...
                        <div class="icon-uno user"></div>
    									...
    									<input id="username" name="username" class="form-control form-control-custom" placeholder="Número de Cuenta" type="text" value="">
    								</div>
